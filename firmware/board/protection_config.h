/*
 * Protection thresholds and fault bitmap for the 24V / 4kW inverter.
 * Hardware ACMP values are 8-bit DAC codes assuming 3.3V ACMP rail.
 */
...
#define IPRI_LIM_A              260.0f
#define IPRI_HW_A               280.0f
#define IPRI_TRIP_COUNT         50
...
#define PSFB_F_SW_HZ            60000
#define INV_F_SW_HZ             20000
#define INV_F_OUT_HZ            50
#define INV_DEADTIME_NS         500
#define PSFB_DEADTIME_NS        200
#define PSFB_MAX_DUTY           0.85f

/* ACMP 8-bit DAC: code = Vth / 3.3 * 255 */
...
enum inv_fault_bit {
    ...
    FAULT_HW_PWM0       = 1u << 14,
    FAULT_HW_PWM1       = 1u << 15,
    FAULT_WATCHDOG      = 1u << 16,
    FAULT_AUX_RAIL      = 1u << 17
};
